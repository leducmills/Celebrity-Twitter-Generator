...
public class CTE extends PApplet {
	...
	String[] files = {"AlecBaldwin", "aplusk" ,"BarackObama", "BillGates", "britneyspears", "ConanOBrien","CornelWest", "DAVID_LYNCH", "doctorow", "donttrythis", "justinbieber", "KariByron", "katyperry", "ladygaga", "lessig", "LilKim", "LilTunechi", "mikeroweworks", "NICKIMINAJ", "Oprah", "ParisHilton", "PerezHilton", "SarahPalinUSA", "snooki",  "SnoopDogg", "StephenAtHome", "SteveMartinToGo","TheEllenShow", "WilliamShatner","yokoono"};
